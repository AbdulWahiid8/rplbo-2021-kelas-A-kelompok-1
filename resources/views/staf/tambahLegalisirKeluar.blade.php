<x-master-layout title="Tambah Legalisir Keluar">
    @section('content')
        <section class="section">
            <section class="section-header">
                <h1>Tambah Legalisir Keluar</h1>
            </section>
            <form action="{{ route('legalisirkeluar.store') }}" class="needs-validation px-5 mt-3" method="POST" enctype="multipart/form-data" >
                @csrf
                <div class="card">
                <div class="card-body">

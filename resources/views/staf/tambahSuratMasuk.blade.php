<x-master-layout title="Tambah Surat Masuk">
    @section('content')
        <section class="section">
            <section class="section-header">
                <h1>Tambah Surat Masuk</h1>
            </section>
            <form action="{{ route('suratmasuk.store') }}" class="needs-validation px-5 mt-3" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="card">
                <div class="card-body">

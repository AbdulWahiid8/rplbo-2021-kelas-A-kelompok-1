<x-master-layout title="Detail Legalisir Keluar">
    @section('content')
        <section class="section">
            <section class="section-header">
                <h1>Detail Legalisir Keluar</h1>
            </section>
            <div class="card">
                <div class="card-body">
                    <div class="row p-2 mt-4">
                        ...
                        <div class="col-md-8">
                            <div class="row mt-2">
                                <div class="ms-5">
                                    <small class="d-inline btn btn-dark btn-sm shadow-none"># Detail Legalisir Keluar</small>
